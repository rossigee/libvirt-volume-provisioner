...
```bash
wget https://github.com/rossigee/libvirt-volume-provisioner/releases/download/v0.6.0/libvirt-volume-provisioner_0.6.0_amd64.deb
sudo apt install ./libvirt-volume-provisioner_0.6.0_amd64.deb
